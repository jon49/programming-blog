...
var gulp, path, del, lodash, browserify, pdc, feed, gulpSitemap, λ, sitemap, stylus, manifest, concat, rename, wrapper, filter, replace, livescript, uglify, frontMatter, ssg, es, pluck, data, source, pandoc, toHtml, toSimpleHtml, posted, toUrlPath, toUrlStylePath, feedData, createFeed;
gulp = require('gulp');
path = require('path');
del = require('del');
...
gulp.task('default', ['clean', 'images', 'js', 'html', 'sitemap', 'json', 'js', 'css']);